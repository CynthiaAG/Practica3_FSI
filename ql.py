...
#e~Greedy , a veces movimiento random para explorar y no solo explotar
...
print Q
#print las acciones promedios
print "Promedio : ", total_actions/100
#print "Acciones totales:", total_actions
